...
/**
 */
public abstract class AbstractAtomicDoubleFieldData implements AtomicNumericFieldData {
    ...
    public static AtomicNumericFieldData empty() {
        return new AbstractAtomicDoubleFieldData() {
