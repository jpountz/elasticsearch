...
public final class ObjectMapperMergeTests extends ESTestCase {
    ...
    private RootObjectMapper createMapping(
        ...
        return rootBuilder.build(MapperBuilderContext.root(false, false, false));
    }
    ...
    private static RootObjectMapper createRootSubobjectFalseLeafWithDots() {
        ...
        FieldMapper fieldMapper = fieldBuilder.build(MapperBuilderContext.root(false, false, false));
    ...
    private static ObjectMapper.Builder createObjectSubobjectsFalseLeafWithDots() {
        ...
        KeywordFieldMapper fieldMapper = fieldBuilder.build(new MapperBuilderContext("foo.metrics", false, false, false));
        assertEquals("host.name", fieldMapper.simpleName());
    ...
    private ObjectMapper.Builder createObjectSubobjectsFalseLeafWithMultiField() {
        ...
        TextFieldMapper textKeywordMultiField = fieldBuilder.build(new MapperBuilderContext("foo.metrics", false, false, false));
